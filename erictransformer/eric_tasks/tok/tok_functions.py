...
def tokenize_chat_template(
    ...
    if model_type == "gpt_oss":
        ...
        len_chat_template = tokenizer.apply_chat_template(message,
                                                          tokenize=True,
        ...
        template_len = len(len_chat_template["input_ids"]) - 5
    ...
    def tokenize_fn(example):
        try:
            ...
            for input_ids in tokens["input_ids"]:
                ...
                # mask out chat template
                if model_type == "gpt_oss":
                    masked[:template_len] = [-100] * template_len
                labels.append(masked)
            tokens["labels"] = labels
